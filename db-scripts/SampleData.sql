...
INSERT INTO categories (id_category, id_supercategory, name, has_children, has_items) 
VALUES ('000', null, 'Computer science, information, and general works', 1, 0);

-- Kategoria niższa 005
INSERT INTO categories (id_category, id_supercategory, name, has_children, has_items) 
VALUES ('005', '000', 'Computer programming, programs, and data', 1, 0);

-- Kategoria niższa 030
INSERT INTO categories (id_category, id_supercategory, name, has_children, has_items) 
VALUES ('030', '000', 'Encyclopedias and books of facts', 1, 0);
...
VALUES ('Programming : principles and practice using C++', '005', null);

INSERT INTO books (title, id_category, minimum_age)
VALUES ('Encyclopædia Britannica', '032', null);

-- copies --
INSERT INTO copies (id_book, id_publisher, id_inventory, year_published)
